...
uint MyRigidBody::SAT(MyRigidBody* const a_pOther)
{
	...
	//the radii of each object
	float ra, rb;
	//the matrices that hold the rotation information of a_pOther
	matrix3 R, AbsR;
	//find the values for Matrix R
	for (int i = 0; i < 3; i++)
	{
		for (int j = 0; j < 3; j++)
		{
	...
	// the distance between both objects centers
	...
	// fills the AbsR matrix with the absolute values of matrix R
	// adds epsilon to each point so each point always has a small value
	// this offsets any errors that would happen with parallel edges
	for (int i = 0; i < 3; i++)
	{
		for (int j = 0; j < 3; j++)
		{
	...
	// Tests to see if the projections of A.x, A.y, A.z onto axis L and determines if it overlaps with a_pOther
	for (int i = 0; i < 3; i++) {
		ra = m_v3HalfWidth[i];
	...
	// Tests to see if the projections of A.x, A.y, A.z onto axis L and determines if it overlaps with THIS object
	for (int i = 0; i < 3; i++) {
	...
	// Tests the cross product of A.x and B.x on L to see if there is any overlap
	...
	// Tests the cross product of A.x and B.y on L to see if there is any overlap
	...
	// Tests the cross product of A.x and B.z on L to see if there is any overlap
	...
	// Tests the cross product of A.y and B.x on L to see if there is any overlap
	...
	// Tests the cross product of A.y and B.y on L to see if there is any overlap
	...
	// Tests the cross product of A.y and B.z on L to see if there is any overlap
	...
	// Tests the cross product of A.z and B.x on L to see if there is any overlap
	...
	// Tests the cross product of A.z and B.y on L to see if there is any overlap
	...
	// Tests the cross product of A.z and B.z on L to see if there is any overlap
