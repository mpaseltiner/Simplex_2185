...
#pragma endregion
	...
	{
		if (fMultiplier)
			m_v3Rotation.x -= 0.10f;
		else
			m_v3Rotation.x += 0.10f;
		quaternion q1 = glm::angleAxis(0.10f, vector3(1.0f, 0.0f, 0.0f));
		m_qOrientation = m_qOrientation * q1;
	}
	if (sf::Keyboard::isKeyPressed(sf::Keyboard::Y))
	{
		if (fMultiplier)
			m_v3Rotation.y -= 0.10f;
		else
			m_v3Rotation.y += 0.10f;
		quaternion q1 = glm::angleAxis(0.10f, vector3(0.0f, 1.0f, 0.0f));
		m_qOrientation = m_qOrientation * q1;
	}
	if (sf::Keyboard::isKeyPressed(sf::Keyboard::Z))
	{
		if (fMultiplier)
			m_v3Rotation.z -= 0.10f;
		else
			m_v3Rotation.z += 0.10f;
		quaternion q1 = glm::angleAxis(0.10f, vector3(0.0f, 0.0f, 1.0f));
		m_qOrientation = m_qOrientation * q1;
	}
